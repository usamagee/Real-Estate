...
import go from "../../Assets/fast.png"
        ...
        >
          <div>
            ...
            <Link to="/admin/product">
              <p style={{display:'flex',alignItems:'center' , paddingTop:'5px', borderRadius:"3px", color: "black", background: "white",paddingRight:"5px"}} >
